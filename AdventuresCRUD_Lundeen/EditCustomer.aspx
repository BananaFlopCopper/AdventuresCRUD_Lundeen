<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="EditCustomer.aspx.cs" Inherits="AdventuresCRUD_Lundeen.EditCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Table ID="Table1" runat="server">
        ...
        <asp:TableRow runat="server">
            ...
            <asp:TableCell ID="SalesPersonIn" runat="server" ><asp:TextBox IsChanged="" ID="txtbxSalesPerson" runat="server"></asp:TextBox></asp:TableCell>
        </asp:TableRow>
    </asp:Table>
    
    <asp:Button ID="Updatebtn" runat="server" Text="Update" OnClick="Updatebtn_Click" />
    <asp:Button ID="Deletebtn" runat="server" Text="Delete" BorderStyle="Outset" OnClick="Deletebtn_Click" OnClientClick="return confirm('Delete this Customer?');" />
    <p visible="false" ID=""></p>
</asp:Content>
